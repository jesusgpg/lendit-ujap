-- El formulario de registro manda careerId (uuid) en los metadatos de Supabase Auth,
-- no el nombre de la carrera. Ajustamos el trigger para resolverlo por id, con fallback
-- a la primera carrera si falta o no es válido.
